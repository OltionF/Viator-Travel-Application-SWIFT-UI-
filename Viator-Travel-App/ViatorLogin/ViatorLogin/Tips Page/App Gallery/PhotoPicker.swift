...
struct PhotoPicker: UIViewControllerRepresentable {
    ...
    func makeCoordinator() -> CoordinatorGallery {
        CoordinatorGallery(self)
    }
...
class CoordinatorGallery: NSObject, UINavigationControllerDelegate, PHPickerViewControllerDelegate {
